...
const ResumePDF = dynamic(() => import("@/components/ResumePDF"), {
  ssr: false,
  loading: () => <p className="font-dos text-sm p-4 text-center mt-10">Initializing document viewer...</p>
});
...
export default function PageComponent() {
  ...
  const [containerWidth, setContainerWidth] = useState<number>(600); // 600px fallback default
